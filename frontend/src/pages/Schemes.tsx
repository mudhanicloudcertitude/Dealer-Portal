    ...
    <div>
      <div className="page-header">
        <div className="page-header-left">
          <h1 className="page-title">🏷️ Schemes & Pricing Slabs</h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '20px' }} className="grid-2-mobile">
                ...
                <div key={s.Id} className="card" style={{ border: '1px solid var(--border)', position: 'relative' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
                    <div>
                      ...
                      <span className="badge badge-purple" style={{ fontSize: '9px', marginTop: '4px', textTransform: 'uppercase' }}>
                        {s.Type__c || 'Incentive Slab'}
                      </span>
                    </div>
                  ...
                  <div className="grid-2" style={{ marginTop: '12px', fontSize: '13px' }}>
                    <div>
                      ...
                      <div style={{ fontWeight: 600, color: 'var(--text-secondary)' }}>📅 {s.Start_Date__c}</div>
                    </div>
                    <div>
                      <div style={{ color: 'var(--text-muted)', marginBottom: '4px' }}>VALID UNTIL</div>
                      <div style={{ fontWeight: 600, color: 'var(--warning)' }}>📅 {s.End_Date__c || 'N/A'}</div>
                    </div>
                  </div>

                  {s.Applicable_Tier__c && (
                    <div style={{ marginTop: '12px', display: 'flex', gap: '8px', alignItems: 'center' }}>
                      <span className="badge badge-warning" style={{ fontSize: '10px' }}>
                        ⭐ VIP: {s.Applicable_Tier__c} Tier Only
                      </span>
                    </div>
                  )}
                </div>
        ...
        <div>
          <div style={{ fontSize: '14.5px', fontWeight: 700, marginBottom: '14px', color: 'var(--text-secondary)' }}>
            🧮 LIVE SCHEME DISCOUNT CALCULATOR
          </div>
